...
- 生成时间：2026-07-23T08:59:20+00:00
...
| RAG Recall@3 | 94.29% |
| RAG MRR | 0.8179 |
| RAG Precision@3 | 34.52% |
| RAG 平均耗时 | 590.2 ms |
| RAG P95 耗时 | 355 ms |

## 失败样本

共 89 条样本至少有一项未达到标注结果。
...
| complaint-en-02 | rag_recall_at_3 | support=True, category=complaint, risk=high | support=True, category=complaint, risk=high |
| complaint-en-03 | risk | support=True, category=complaint, risk=high | support=True, category=complaint, risk=low |
| complaint-en-04 | rag_recall_at_3 | support=True, category=complaint, risk=high | support=True, category=complaint, risk=high |
...
| ext-complaint-en-02 | rag_recall_at_3 | support=True, category=complaint, risk=high | support=True, category=complaint, risk=high |
| ext-complaint-zh-03 | category, risk | support=True, category=complaint, risk=high | support=True, category=refund, risk=low |
| ext-complaint-en-03 | category, risk, rag_recall_at_3 | support=True, category=complaint, risk=high | support=True, category=refund, risk=low |
...
| ext-complaint-zh-06 | risk, rag_recall_at_3 | support=True, category=complaint, risk=high | support=True, category=complaint, risk=low |
...
| ext-complaint-en-07 | category, risk, rag_recall_at_3 | support=True, category=complaint, risk=high | support=True, category=other, risk=low |
| ext-complaint-zh-08 | category, risk | support=True, category=complaint, risk=high | support=True, category=other, risk=low |
| ext-complaint-en-08 | category, risk, rag_recall_at_3 | support=True, category=complaint, risk=high | support=True, category=other, risk=low |
